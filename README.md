...
- `1.8`, `1.8.31` - Last official release from the 1.8 branch
- `1.7`, `1.7.41` - Last official release from the 1.7 branch
- `1.6`, `1.6.33` - Last official release from the 1.6 branch
- `1.5`, `1.5.30` - Last official release from the 1.5 branch
- `1.4`, `1.4.42` - Last official release from the 1.4 branch
